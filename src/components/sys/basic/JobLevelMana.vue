<template>
    <div>
        <div>
            ...
            <el-select v-model="jl.titleLevel" placeholder="职称等级" size="small" style="margin-left: 8px;margin-right: 8px">
                <el-option
            ...
            <div>
                <table>
                    ...
                    <tr>
                        ...
                        <el-select v-model="updateJl.titleLevel" placeholder="职称等级" size="small" style="margin-left: 8px;margin-right: 8px">
                            <el-option
                                    v-for="item in titleLevels"
                                    :key="item"
                                    :label="item"
